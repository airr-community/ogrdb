...
def setup_sequence_view_tables(db, seq, private):
    sections = {}
    sections['details'] = ["species", "species_subgroup", "species_subgroup_type", "sequence_name", "imgt_name", "alt_names", "affirmation_level", "sequence", "coding_seq_imgt", "functionality", "inference_type", "paralogs"]
