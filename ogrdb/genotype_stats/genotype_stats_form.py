...
class GeneStatsForm(FlaskForm):
    ...
    allelic_threshold = DecimalField('Minimum Allelic Percentage', [NumberRange(min=0.0, max=100.0)], description="The number of sequences exactly matching the sequence of this allele divided by the number of sequences exactly matching any allele of this specific gene must meet this threshold", places=2, default=20.0)
    assigned_unmutated_threshold = DecimalField('Minimum Unmutated Percentage', [NumberRange(min=0.0, max=100.0)], description="The number of sequences exactly matching this allele divided by the number of sequences assigned to this allele must meet this threshold", places=2, default=20.00)
...
class GeneStats_table(StyledTable):
    ...
    unmutated_freq = StyledCol("Unmutated Frequency", tooltip="The number of sequences exactly matching the sequence of this allele divided by the number of sequences exactly matching any allele of any gene, expressed as a percentage, averaged over all included genotypes")
