...
def main(argv):
    ...
    write_model(schema, 'ForwardPrimer', 'db/repertoire_db.py', True)
    write_model(schema, 'ReversePrimer', 'db/repertoire_db.py', True)
    ...
    write_flaskform(schema, 'ForwardPrimer', 'forms/repertoire_form.py', True)
    write_flaskform(schema, 'ReversePrimer', 'forms/repertoire_form.py', True)
