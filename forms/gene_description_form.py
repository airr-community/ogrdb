...
class GeneDescriptionForm(FlaskForm):
    ...
    inference_type = SelectField('Inference Type', choices=[('Unrearranged and Rearranged', 'Unrearranged and Rearranged'), ('Unrearranged', 'Unrearranged'), ('Rearranged', 'Rearranged')], description="Type of inference(s) from which this gene sequence was inferred (Unrearranged and Rearranged, Unrearranged Only, Rearranged Only)")
...
class GenomicSupportForm(FlaskForm):
    sequence_type = SelectField('Type', choices=[('Locational', 'Locational'), ('Nonlocational', 'Nonlocational')], description="Locational should be used where the unrearranged sequence includes multiple genes, enabling the location of this gene to be determined relative to others")
