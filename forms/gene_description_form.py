...
class GeneDescriptionForm(FlaskForm):
    ...
    coding_seq_imgt = TextAreaField('Coding Sequence', [ValidNucleotideSequence(ambiguous=False, gapped=True)], description="nucleotide sequence of the coding region, aligned, in the case of a V-gene, with the IMGT numbering scheme. For a heavy chain C gene, this should be the transmembrane form.")
    secretory_coding_sequence = TextAreaField('SC Coding Sequence', [validators.Length(max=10000)], description="Nucleotide sequence of the coding region of the secretory domain of an IGH/IGI C-gene). The sequence of the cytoplasmic form and the sequence of the coding domain of all other C-genes should be placed in coding_sequence.")
    ...
    c_exon_9_start = IntegerField('Exon 9 Start', [validators.Optional()], description="Start coordinate in the sequence field of the ninth constant region exon (C-genes only).")
    c_exon_9_end = IntegerField('Exon 9 End', [validators.Optional()], description="End coordinate in the sequence field of the ninth constant region exon (C-genes only).")
