...
class GeneDescriptionForm(FlaskForm):
    ...
    inference_type = SelectField('Inference Type', choices=[('Unrearranged and Rearranged', 'Unrearranged and Rearranged'), ('Unrearrange Only', 'Unrearrange Only'), ('Rearranged Only', 'Rearranged Only')], description="Type of inference(s) from which this gene sequence was inferred (Unrearranged and Rearranged, Unrearranged Only, Rearranged Only)")
