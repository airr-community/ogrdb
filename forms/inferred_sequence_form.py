...
class InferredSequenceForm(FlaskForm):
    ...
    seq_accession_no = StringField('Accession Number', [validators.Length(max=255), validators.Optional()], description="Accession number of the inferred allele within the repository, e.g. BK010573 (NCBI), MK308864 (ENA)")
    ...
    run_ids = StringField('Select sets', [validators.Length(max=255), validators.Optional()], description="Comma-separated list of accession number(s) of the selected records from the sequencing runs that directly support this inference, e.g. SRR7154792 (NCBI), ERX3006608 (ENA)")
