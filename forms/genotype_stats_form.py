...
class GeneStatsForm(FlaskForm):
    ...
    sig_test = BooleanField('Significance Test', description='Apply significance test to the proportion of unmutated sequences', default=True)
    allelic_threshold = DecimalField('Minimum Allelic Percentage', [NumberRange(min=0.0, max=100.0)], description="Minimum percentage of unmutated sequences assigned to this allele as opposed to other alleles of the same gene", places=2, default=20.0)
