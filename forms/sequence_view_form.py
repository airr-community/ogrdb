...
def setup_sequence_view_tables(db, seq, private):
    sections = {}
    sections['details'] = ["species", "species_subgroup", "species_subgroup_type", "sequence_name", "imgt_name", "alt_names", "affirmation_level", "sequence", "coding_seq_imgt", "secretory_coding_sequence", "functionality", "inference_type", "mapped", "paralogs", "paralog_rep"]
    ...
    sections['non-coding'] = ["utr_5_prime_start", "utr_5_prime_end", "leader_1_start", "leader_1_end", "l_part1", "leader_2_start", "leader_2_end", "l_part2", "v_rs_start", "v_rs_end", "v_heptamer", "v_nonamer", 
                              ...
                              "c_exon_7_end", "c_exon_8_start", "c_exon_8_end", "c_exon_9_start", "c_exon_9_end", "utr_3_prime_start", "utr_3_prime_end"]
    ...
    if seq.sequence_type == 'C':
        wanted.extend(['c_exon_1_start', 'c_exon_1_end', 'c_exon_2_start', 'c_exon_2_end', 'c_exon_3_start', 'c_exon_3_end', 'c_exon_4_start', 'c_exon_4_end', 'c_exon_5_start', 'c_exon_5_end', 'c_exon_6_start', 'c_exon_6_end', 'c_exon_7_start', 'c_exon_7_end', 
                       'c_exon_8_start', 'c_exon_8_end','c_exon_9_start', 'c_exon_9_end', 'utr_3_prime_start', 'utr_3_prime_end', 'secretory_coding_sequence'])

    optional_fields = ['secretory_coding_sequence', 'leader_1_start', 'leader_1_end', 'leader_2_start', 'leader_2_end', 'l_part1', 'l_part2', 'utr_5_prime_start', 'utr_5_prime_end', 'inferred_extension', 'ext_3prime', 'start_3prime_ext', 'end_3prime_ext', 'ext_5prime', 'start_5prime_ext', 'end_5prime_ext',
