...
def setup_sequence_view_tables(db, seq, private):
    sections = {}
    sections['details'] = ["species", "sequence_name", "imgt_name", "coding_sequence_identifier", "affirmation_level", "sequence", "coding_seq_imgt", "functional", "inference_type", "alt_names", "paralogs"]
