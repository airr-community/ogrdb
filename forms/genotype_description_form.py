...
class GenotypeDescriptionForm(FlaskForm):
    ...
    genotype_biosample_ids = StringField('Sample IDs', [validators.Length(max=255), NonEmpty()], description="Comma-separated list of accession number(s) of the sample(s) from which the genotype was derived (e.g. NIH biosamples or ENA samples)")
