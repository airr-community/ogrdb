...
class Genotype_table(StyledTable):
    ...
    nt_substitutions = StyledCol("NT Substs", tooltip="For inferred alleles, Comma-separated list of nucleotide substitutions (e.g. G112A) between this sequence and the closest reference gene and allele")
    ...
    aa_substitutions = StyledCol("AA Substs", tooltip="For inferred alleles, List of amino acid substitutions (e.g. A96N) between this sequence and the closest reference gene and allele. Please use IMGT numbering for V-genes, and number from start of coding sequence for D- or J- genes.")
...
def make_Genotype_view(sub, private = False):
    ...
    ret.items.append({"item": "NT Substs", "value": sub.nt_substitutions, "tooltip": "For inferred alleles, Comma-separated list of nucleotide substitutions (e.g. G112A) between this sequence and the closest reference gene and allele", "field": "nt_substitutions"})
    ...
    ret.items.append({"item": "AA Substs", "value": sub.aa_substitutions, "tooltip": "For inferred alleles, List of amino acid substitutions (e.g. A96N) between this sequence and the closest reference gene and allele. Please use IMGT numbering for V-genes, and number from start of coding sequence for D- or J- genes.", "field": "aa_substitutions"})
