...
class GeneDescription_table(StyledTable):
    ...
    sequence_type = StyledCol("Sequence Type", tooltip="Sequence type (V, D, J, C)")
    ...
    c_exon_1_start = StyledCol("Exon 1 Start", tooltip="Start coordinate in the sequence field of the first constant region exon (C-genes only).")
    c_exon_1_end = StyledCol("Exon 1 End", tooltip="End coordinate in the sequence field of the first constant region exon (C-genes only).")
    c_exon_2_start = StyledCol("Exon 2 Start", tooltip="Start coordinate in the sequence field of the second constant region exon (C-genes only).")
    c_exon_2_end = StyledCol("Exon 2 End", tooltip="End coordinate in the sequence field of the second constant region exon (C-genes only).")
    c_exon_3_start = StyledCol("Exon 3 Start", tooltip="Start coordinate in the sequence field of the third constant region exon (C-genes only).")
    c_exon_3_end = StyledCol("Exon 3 End", tooltip="End coordinate in the sequence field of the third constant region exon (C-genes only).")
    c_exon_4_start = StyledCol("Exon 4 Start", tooltip="Start coordinate in the sequence field of the fourth constant region exon (C-genes only).")
    c_exon_4_end = StyledCol("Exon 4 End", tooltip="End coordinate in the sequence field of the fourth constant region exon (C-genes only).")
    c_exon_5_start = StyledCol("Exon 5 Start", tooltip="Start coordinate in the sequence field of the fifth constant region exon (C-genes only).")
    c_exon_5_end = StyledCol("Exon 5 End", tooltip="End coordinate in the sequence field of the fifth constant region exon (C-genes only).")
    c_exon_6_start = StyledCol("Exon 6 Start", tooltip="Start coordinate in the sequence field of the sixth constant region exon (C-genes only).")
    c_exon_6_end = StyledCol("Exon 6 End", tooltip="End coordinate in the sequence field of the sixth constant region exon (C-genes only).")
    c_exon_7_start = StyledCol("Exon 7 Start", tooltip="Start coordinate in the sequence field of the seventh constant region exon (C-genes only).")
    c_exon_7_end = StyledCol("Exon 7 End", tooltip="End coordinate in the sequence field of the seventh constant region exon (C-genes only).")
    c_exon_8_start = StyledCol("Exon 8 Start", tooltip="Start coordinate in the sequence field of the eighth constant region exon (C-genes only).")
    c_exon_8_end = StyledCol("Exon 8 End", tooltip="End coordinate in the sequence field of the eighth constant region exon (C-genes only).")
    c_exon_9_start = StyledCol("Exon 9 Start", tooltip="Start coordinate in the sequence field of the ninth constant region exon (C-genes only).")
    c_exon_9_end = StyledCol("Exon 9 End", tooltip="End coordinate in the sequence field of the ninth constant region exon (C-genes only).")
    utr_3_prime_start = StyledCol("UTR 3\' Start", tooltip="Start co-ordinate in the sequence field of the 3 prime UTR (V-genes only).")
    utr_3_prime_end = StyledCol("UTR 3\' End", tooltip="End co-ordinate in the sequence field of the 3 prime UTR (V-genes only).")
...
def make_GeneDescription_view(sub, private = False):
    ...
    ret.items.append({"item": "Sequence Type", "value": sub.sequence_type, "tooltip": "Sequence type (V, D, J, C)", "field": "sequence_type"})
